...
@section('title', 'LABORATORY TEST (PERFORM)')

@section('breadcrumbs')
    <span>TRANSACTION / PATIENT MANAGEMENT</span> / <span class="highlight">LABORATORY - PERFORM</span>
@endsection
...
<script src="/js/backend/pages/hms/transaction/patient_management/laboratory_test.js"></script>
@endsection
