   ...
   scion.create.table(
        ...
        [
            { data: "id", title:"<input type='checkbox' class='multi-checkbox' onclick='scion.table.checkAll()'/>", render: function(data, type, row, meta) {
                ...
                html += '<a class="align-middle edit" onclick="forValidate('+ row.id + ' )"><i class="fas fa-check"></i></a>';
...
function forValidate(id) {

    if (!confirm('Are you sure you want to mark this as PERFORMED?')) {
        return;
    }
...
function submitValidation() {
    ...
    $.ajax({
        url: `/actions/lab_perform/validate/${validateId}`,
        type: 'POST',
        data: {
