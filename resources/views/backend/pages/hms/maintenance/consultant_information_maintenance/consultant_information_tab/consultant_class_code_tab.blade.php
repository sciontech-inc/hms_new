<div id="consultant_class_code_tab" class="form-tab">
    <h5>CATEGORY</h5>
    <div class="consultant-class-code-table">
        <div class="row">
            <div class="col-12">
                <table id="consultant_class_code_table" class="table table-striped" style="width:100%">
                </table>
            </div>
        </div>
    </div>
...
<div class="sc-modal-content" id="consultant_class_code_form">
    <div class="sc-modal-dialog sc-xl">
        ...
        <div class="sc-modal-body">
            <form method="post" id="consultantclasscodeForm" class="form-record">
                <div class="row">
