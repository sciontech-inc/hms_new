<div id="consultant_category_tab" class="form-tab">
    <h5>CATEGORY</h5>
    <div class="consultant-category-table">
        <div class="row">
            <div class="col-12">
                <table id="consultant_category_table" class="table table-striped" style="width:100%">
                </table>
            </div>
        </div>
    </div>
