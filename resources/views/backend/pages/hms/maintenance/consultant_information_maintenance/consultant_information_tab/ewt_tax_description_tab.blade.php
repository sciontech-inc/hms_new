<div id="ewt_tax_description_tab" class="form-tab">
    <h5>EWT TAX DESCRIPTION</h5>
    <div class="ewt-tax-description-table">
        <div class="row">
            <div class="col-12">
                <table id="ewt_tax_description_table" class="table table-striped" style="width:100%">
                </table>
            </div>
        </div>
    </div>
...
<div class="sc-modal-content" id="ewt_tax_description_form">
    <div class="sc-modal-dialog sc-xl">
        ...
        <div class="sc-modal-body">
            <form method="post" id="ewttaxdescriptionForm" class="form-record">
                <div class="row">
