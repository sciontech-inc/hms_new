   ...
   scion.create.table(
        ...
        [
            { data: "id", title:"<input type='checkbox' class='multi-checkbox' onclick='scion.table.checkAll()'/>", render: function(data, type, row, meta) {
                ...
                html += '<a class="align-middle edit" onclick="forNote('+ row.id + ' )"><i class="fas fa-check"></i></a>';
...
function forNote(id) {
    ...
    if (!confirm('Are you sure you want to mark this as VALIDATED?')) {
        return;
    }
...
function submitValidation() {
    ...
    $.ajax({
        url: `/actions/lab_perform/noted/${validateId}`,
        type: 'POST',
        data: {
