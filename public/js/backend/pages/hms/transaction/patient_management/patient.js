    ...
    switch(module_content) {
        ...
        case 'patient':
            ...
            form_data = {
                ...
                is_child: $('#is_child')[0].checked === true? 1:0,
                non_local: $('#non_local')[0].checked === true? 1:0,
                is_hospital_employee: $('#is_hospital_employee')[0].checked === true? 1:0,
                is_blacklisted: $('#is_blacklisted')[0].checked === true? 1:0,
                is_personal_data_released: $('#is_personal_data_released')[0].checked === true? 1:0,
                is_no_communication_from_company: $('#is_no_communication_from_company')[0].checked === true? 1:0,
                passport_no: $('#passport_no').val(),
                xray_file_no: $('#xray_file_no').val(),
                is_confidential_patient: $('#is_confidential_patient')[0].checked === true? 1:0,
                is_fictitious_birth_date: $('#is_fictitious_birth_date')[0].checked === true? 1:0,
