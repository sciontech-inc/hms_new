$(function() {
    ...
    modal_content = 'department';
    module_content = 'department';
    ...
    scion.create.table(
        ...
        [
            ...
            { data: "id", title: "ID" },
            { data: "department_code", title: "DEPARTMENT CODE" },
...
function success() {
    ...
    $('#department_table').DataTable().draw();
    scion.create.sc_modal('department_form').hide('all', modalHideFunction)
}
