<div id="consultant_service_class_tab" class="form-tab">
    <h5>SERVICE CLASS</h5>
    <div class="consultant-service-class-table">
        <div class="row">
            <div class="col-12">
                <table id="consultant_service_class_table" class="table table-striped" style="width:100%">
                </table>
            </div>
        </div>
    </div>
