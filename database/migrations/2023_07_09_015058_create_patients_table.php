...
class CreatePatientsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('patients', function (Blueprint $table) {
            ...
            $table->integer('non_local')->nullable();
            $table->integer('is_hospital_employee')->nullable();
            $table->integer('is_blacklisted')->nullable();
            $table->integer('is_personal_data_released')->nullable();
            $table->integer('is_no_communication_from_company')->nullable();
            $table->text('passport_no')->nullable();
            $table->string('xray_file_no')->nullable();
            $table->integer('is_confidential_patient')->nullable();
            $table->integer('is_fictitious_birth_date')->nullable();
