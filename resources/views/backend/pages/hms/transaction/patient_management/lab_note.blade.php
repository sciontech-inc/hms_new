...
@section('title', 'LABORATORY TEST (NOTE)')

@section('breadcrumbs')
    <span>TRANSACTION / PATIENT MANAGEMENT</span> / <span class="highlight">LABORATORY - NOTE</span>
@endsection
        ...
        <div class="card">
            ...
            <div class="col-12">
                ...
                <div class="row" style="height: 100%; display:none" >
                    <iframe 
                        src="{{ route('forms.laboratory_test') }}" 
...
<script src="/js/backend/pages/hms/transaction/patient_management/laboratory_note.js"></script>
@endsection
